...
export const YOUTUBE_CHANNELS = [
  ...
  { key: 'minecraft', id: 'UC-ASoLp2wfxVLJFDnVXwrGA', name: 'Ultra OP 2.0', handle: '@ultraop2', focus: 'Minecraft and the next gaming era', uploadsPlaylist: 'UU-ASoLp2wfxVLJFDnVXwrGA', url: 'https://www.youtube.com/@ultraop2' },
